...
import { play, tick, pause, resume, stop } from 'state/actions';
import stopwatch, { initialState } from 'state/reducers/stopwatch';
...
describe('stopwatch reducer', function() {
    ...
    context('PLAY/PAUSE/RESUME/TICK', function() {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        setTimeout(function() {
                            ...
                            stateAfterSecondPause = stopwatch(
                                stateAfterTick,
                                secondPauseAction
                            );

                            stopAction = stop();
                            stateAfterStop = stopwatch(
                                stateAfterSecondPause,
                                stopAction
                            );
        ...
        it('should be back "on" on "RESUME" action and no time should have gone by', function() {
            ...
            expect(stateAfterResume.offset).toBe(
                resumeAction.time - stateAfterPause.elapsed
            );
        });

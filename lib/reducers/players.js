 ...
 * @param {number} now - The moment when the pause is done
 * @returns {PlayerTimer}
 */
function pauseActivePlayer(activeUserTime, now) {
  return Object.assign(
    {},
    activeUserTime,
    diff(activeUserTime.offset, now + activeUserTime.elapsed),
    { elapsed: activeUserTime.elapsed + now - activeUserTime.offset }
  );
}

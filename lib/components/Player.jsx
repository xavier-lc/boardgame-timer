...
function Player(props) {
    ...
    const playerCls = classnames('player', {
        inactive: !props.isEditable && !props.isActive
    });

    const spanCls = classnames('player__name', { hidden: props.isEditable });

    const progressCls = classnames('progress', { hidden: props.isEditable });

    const progressBarCls = classnames('progress-bar', 'progress-bar-striped', {
